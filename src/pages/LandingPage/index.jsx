  ...
  return (
    <>
        ...
        <div className='w-3/5 h-full p-20 flex justify-center items-center'>
          <div>
            ...
            <p className='text-md text-justify my-4'>
              ...
              nesciunt, magni perspiciatis dignissimos at accusamus sed deleniti
              officia nobis nihil aliquid asperiores cum delectus repudiandae
              impedit beatae eveniet dicta consequatur autem minus nulla?
              Architecto obcaecati esse sint hic ipsa! Labore amet illum
              excepturi quaerat aspernatur?
            </p>
            <button
        ...
        <div className='w-2/5 flex justify-center items-center'>
          <div className='pl-20 pr-8'>
            ...
            <p className='text-md text-justify my-4'>
              ...
              libero, nemo aspernatur magnam sapiente ad aliquid illo voluptate
              quo, aliquam nisi eaque earum accusantium. Lorem ipsum dolor sit
              amet consectetur adipisicing elit. Saepe, aspernatur.
            </p>
            <button
              className='py-2 px-4 bg-purple-700 text-sm rounded-md shadow-xl font-medium text-slate-100 tracking-wide
              hover:bg-purple-900 transit'
        ...
        <div className='w-3/5 bg-gray-400 flex justify-center items-center'>
          <div className='w-[40%]'>
            ...
            <p className='text-md my-4'>
              Temukan informasi lengkap tentang proses penerimaan dan pesyaratan
              yang dibutuhkan
            </p>
      ...
      <div className='w-full h-[600px] flex justify-center items-center'>
        <div>
          <h2 className='text-2xl font-bold text-center py-10'>Visi & Misi</h2>
